...
public class HomeAdapter extends BaseAdapter {
    ...
    private List<LeiBieBean.DataBean> foodDatas;

    public HomeAdapter(Context context, List<LeiBieBean.DataBean> foodDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        LeiBieBean.DataBean dataBean = foodDatas.get(position);
        List<LeiBieBean.DataBean.DataListBean> dataList = dataBean.getDataList();
