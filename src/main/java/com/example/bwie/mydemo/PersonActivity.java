...
import com.example.bwie.mydemo.http.OkUtils;
...
import static com.example.bwie.mydemo.R.id.llt;
import static com.example.bwie.mydemo.R.id.person_icon;
...
public class PersonActivity extends AppCompatActivity {
    ...
    @BindView(person_icon)
    ImageView mPersonIcon;
    @BindView(R.id.bt_camera)
    Button mBtCamera;
    @BindView(R.id.bt_xiangce)
    Button mBtXiangce;
    ...
    @OnClick({R.id.person_back, R.id.person_logo, person_icon, R.id.bt_camera, R.id.bt_xiangce, R.id.btn_cancel})
...
*/
    ...
    public  void setImgByStr(String imgStr, String imgName) {
        ...
        params.put("uid", "3027");// 11459832
        params.put("file", imgStr);
        OkUtils.postAsync(url, params, new OkUtils.DataCallBack() {
            @Override
    ...
    private void getBitmapFromSharedPreferences(){
        ...
        if(byteArray.length==0){
            mPersonIcon.setImageResource(R.mipmap.ic_launcher);
        }else{
